...
import com.example.numberbook.data.ApiResponse;
import com.example.numberbook.data.Contact;
import com.example.numberbook.data.ContactApi;
import com.example.numberbook.data.RetrofitClient;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void syncContactsToServer() {
        if (contactList.isEmpty()) {
            Toast.makeText(this, "Aucun contact charge", Toast.LENGTH_SHORT).show();
            return;
        }
